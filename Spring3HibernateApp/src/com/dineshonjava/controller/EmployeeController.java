...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute("command") EmployeeBean employeeBean,@Valid EmployeeBean employeeObj, 
			BindingResult result) {
		 if (result.hasErrors()) {
	            // if request param validation fails this block executes.
