...
<p style="color:red;font-weight:bold;">To search Book please click <a href="<c:url value='/search' />" >
	Here
</a>
</p>
...
<c:if test="${!empty bookList}">
	...
	<c:forEach items="${bookList}" var="book">
		<tr>
			...
			<td  align="center">
				<a href="#" onclick="javascript:deleteBook(${book.id})">Delete</a>||<a href="<c:url value='/edit/${book.id}' />">Edit</a>
			</td>
		</tr>
	</c:forEach>
	</table>
