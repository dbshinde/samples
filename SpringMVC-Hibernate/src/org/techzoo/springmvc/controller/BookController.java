...
public class BookController {
	...
	public String seacrhBook(Map<String, Object> map)
	{
		map.put("book", new Book());
		map.put("bookList", bookService.listBooks());
		return "seacrhBook";
	}
	@RequestMapping(value = "/seacrhBook")
	public String seacrhBook(@RequestParam("author")String author,Map<String, Object> map)
	{
		map.put("book", new Book());
		map.put("bookList", bookService.searchBooks(author));
		return "seacrhBook";
	}
}